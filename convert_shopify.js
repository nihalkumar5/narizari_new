const fs = require('fs');
let html = fs.readFileSync('legacy_html/shopify.html', 'utf8');
...
fs.writeFileSync('src/app/shopify/page.js', output);
console.log("Converted shopify.html to shopify/page.js");
